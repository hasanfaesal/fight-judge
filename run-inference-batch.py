"""
Batch inference script for ViTPose with keypoint result saving.
Processes all images and saves keypoint predictions to JSON files.
"""
...
def save_keypoints_to_json(pose_results, output_path):
    ...
    for result in pose_results:
        json_result = {
            'keypoints': result['keypoints'].tolist(),  # Shape: [num_keypoints, 3] (x, y, score)
...
def main():
    ...
    parser.add_argument('--img-root', type=str, required=True, help='Image root directory')
    ...
    parser.add_argument('--out-json-root', type=str, default='', 
    ...
    parser.add_argument('--bbox-thr', type=float, default=0.0,
